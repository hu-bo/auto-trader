...
import (
	...
	"exchange-adapter-service/internal/market/publisher"
...
func (a *App) Start(ctx context.Context) error {
	...
	if a.repo != nil {
		...
		if err := a.historySync.StartCronSyncSymbols(); err != nil {
			log.Error().Err(err).Msg("market: start symbols sync cron failed")
		}
	} else {
