...
```bash
curl "http://localhost:9003/api/candles?exchange=binance&symbol=BTC-USDT&period=15m&limit=10"
```
...
```json
{
  ...
  "status": "ok",
  "data": {
    "columns": ["timestamp", "open", "high", "low", "close", "volume", "buy_volume"],
    "data": [
      [1703001600000, 45000.5, 45100.0, 44950.0, 45050.0, 12.5, 7.3],
      [1703001900000, 45050.0, 45200.0, 45000.0, 45150.0, 13.2, 8.1]
    ]
  }
}
```
...
```bash
curl "http://localhost:9003/api/orderbook?exchange=binance&symbol=BTC-USDT&range=0.05"
```
...
```json
{
  ...
  "data": {
    ...
    "tasks": [
      {
        "id": "binance:BTC-USDT:spot",
        "exchange": "binance",
        "symbol": "BTC-USDT",
        "trade_type": "spot",
        "status": "running",
        "created_at": "2025-01-23T10:00:00Z",
        "started_at": "2025-01-23T10:05:30Z"
      }
    ]
  }
}
